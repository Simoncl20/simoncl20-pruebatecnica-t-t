...
const Hero = () => {
  return (
    <section
      className="relative w-full h-[820px] bg-cover justify-center items-center flex flex-col"
    ...
    >
      ...
      <div className='flex flex-col items-center justify-center gap-4 pb-10'>
        ...
        <h2 className='text-amber-300 font-bold text-4xl tracking-[1.5em]'>EXPERIENCE</h2>
      </div>
